# BMAD Templates - template

**Phase:** template
**Created:** 2025-06-11T19:47:21.692Z
...
**Metadata:**
- Word Count: 4246
- Character Count: 32786
- Tags: template, api, database, frontend, backend, security, performance, testing, deployment, architecture, requirements, ui-ux
- Summary: ## Introduction / Preamble

{This document outlines the overall project architecture, including backend systems, shared services, and non-UI specific concerns.  Its primary goal is to serve as the g...
